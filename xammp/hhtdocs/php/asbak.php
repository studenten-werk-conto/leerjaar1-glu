...
if (count($_POST) > 0) {
	...
	echo "<br><br>";
	echo "je verdient " . $werkuren * $uurloon . " euro per week"; //rekent en print de inkomsten per week note: niet overflow bestendig
	echo "<br>";
	if ($html < 0) { // checkt of (programeer ding) welke waarde de checkbox heeft en op basis daarvan een output print
		echo ("je bent niet goed in html");
		echo "<br>";
	} else {
		echo ("je bent goed in html");
		echo "<br>";
	}
	if ($php < 0) {
		echo ("je bent niet goed in php");
		echo "<br>";
	} else {
		echo ("je bent goed in php");
		echo "<br>";
	}
	if ($js < 0) {
		echo ("je bent niet goed in js");
		echo "<br>";
	} else {
		echo ("je bent goed in js");
		echo "<br>";
	}
	if ($php < 0) {
		echo ("je bent niet goed in php");
	...
	if ($mysql < 0) {
		echo ("je bent niet goed in mysql");
		echo "<br>";
	} else {
		echo ("je bent goed in msql");
		echo "<br>";
	}

	// 340,282,366,920,938,463,463,374,607,431,768,211,455 interger overflow test
	if ($leeftijd >= "18") {
		echo "je mag stemmen";
	} else {
	...
	// zegt in welke klas je zit 
	switch ($klas) {
		case '1WDV1-a':
			echo "je zit in 1WDV1-a";
			break;
		case '1WDV1-b':
			echo "je zit in 1WDV1-b";
			break;
		case '1WDV2-a':
			echo "je zit in 1WDV2-a";
			break;
		case '1WDV2-b':
			echo "je zit in 1WDV2-b";
			break;
		default:
			echo "je hebt waarschijnlijk -onbekend- aangeklikt";
			break;
	}
...
<head>
	...
	<title>PHP Eindopdracht - constantijn van hartesveldt 1wdv1-a</title>
...
<body>
	...
	<form method="POST">
		...
		<!-- Kan je hier een loop plaatsen die alle 40 opties plaatst? ja natuurlijk -->
